/**
 * module to detect 'mobile', 'tablet', and 'desktop' browser type
 *
 *
 **/
(function(angular) {
    'use strict';
    angular.module('deviceDetectorModule', [])
        .factory('deviceDetector', ['$window', function($window) {
